...
public partial class IncomeAndExpense : ContentPage
{
    ...
    void ShowIncome()
    {
        ...
        TransactionList.ItemsSource = AllData
            .Where(x => x.Type?.ToLower() == "income")
            .ToList();
    }
    ...
    void ShowExpense()
    {
        ...
        TransactionList.ItemsSource = AllData
            .Where(x => x.Type?.ToLower() == "expense")
            .ToList();
    }
    ...
    void UpdateTabUI(Border border, Label lbl, Label amt, bool isSelected)
    {
        ...
        lbl.TextColor = isSelected ? Colors.White : Colors.Black;
        amt.TextColor = isSelected ? Colors.White : Colors.Black;
    }
